...
public class EC_PlayerMovement : EC_Movement, IPusheable<Vector3>
{
    #region Fields
    ...
    public override void SetUpComponent(GameEntity entity)
    {
        ...
        maxAcceleration *= SceneSettings.Instance.forceMultiplier;
        maxDecceleration *= SceneSettings.Instance.forceMultiplier;
        jumpForce *= SceneSettings.Instance.forceMultiplier;
